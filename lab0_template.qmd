...
car_data <- read_csv("C:/Users/46117/Documents/GitHub/Zhuosi/lab_0/data/car_sales_data.csv")
```
...
- Problematic names: [Engine size, Fuel type, and Year of manufacture]
...
**Your answer:** [The tibble version only shows the first 10 rows and only some columns, with a note "1 more variable: Price <dbl>". Data frame prints all columns and all rows.]
...
**Your answer:** [It contains spaces, so it isn't a valid name in R and needs backticks, while year has no spaces, so it can be used directly without backticks.]
